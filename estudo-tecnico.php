...
<head>
    ...
    <title>Ampère Jr. - Estudo Técnico</title>
...
<body>
    ...
    <section class="service-page">
        <header class="title-align">
            <h2 class="title">Estudo Técnico</h2><!--title-->
        </header><!--title-align-->

        <div class="container">
            <header class="titulo-paginas-secundarias">
                <h2 class="heading">O que é um Estudo Técnico?
                </h2>
            </header>
            ...
            <div class="servico-conteudo">
                <div class="texto-paginas-secundarias">
                    <p>
                        Na categoria de estudo técnico, nós oferecemos dois serviços. Sendo um deles a análise do seu produto, determinando especificações técnicas do mesmo, sua eficiência e visando a sua melhoria.
                    </p>
                    <p>
                        Outro serviço é a prototipagem, onde nós criamos um produto do zero, de acordo com a sua necessidade.
                    </p>

                    <div class="etapas-servico">
                        <ul>
                            <li>
                                <p class="menu-title"><b>Etapas da Análise de Produto:</b></p>
                            </li>
                            <li>
                                <p>
                                    - Revisão detalhada do produto, suas características, funcionamento e eficiência;
                                </p>
                            </li>
                            <li>
                                <p>
                            ...
                            <li>
                                <p>
                                    - Elaboração de ensaios descritivos do funcionamento do produto.
                                </p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="etapas-servico-2">
                        <ul>
                            <li>
                                <p class="menu-title"><b>Etapas da Prototipagem:</b></p>
                            </li>
                            <li>
                                <p>
                            ...
                            <li>
                                <p>
                                    - Projeto do circuito do produto;
                                </p>
                            </li>
                            <li>
                                <p>
                            ...
                            <li>
                                <p>
                                    - Testes de funcionamento do produto;
                                </p>
                            </li>
                            <li>
                                <p>
                                    - Elaboração do manual de utilização.
                                </p>
                            </li>
                        </ul>
                    </div>
